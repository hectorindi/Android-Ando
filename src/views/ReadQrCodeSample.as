...
package views
{
	...
	public class ReadQrCodeSample extends Sprite 
	{
		 ...
		 * コンストラクタ
		 */
		public function ReadQrCodeSample(view:Group,callback:Function):void {
			view = view;
			_callback = callback;
		...
		private function buildCameraView():Sprite {
			...
			camera.setMode(SRC_SIZE, SRC_SIZE, 15, false );
		...
		private function buildResultView():Sprite {
			...
			btnSprite.graphics.drawRoundRect(0, 0, 120, 20, 8);
		...
		public function destroy():void
		{
			...
			redTimer.removeEventListener(TimerEvent.TIMER_COMPLETE, onRedTimer );
